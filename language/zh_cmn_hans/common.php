...
$lang = array_merge($lang, array(
	...
	'EDIT_P_POINTS_TITLE'				=> '您可以修改用户的 %s.',
	...
	'EDIT_SET_AMOUNT'					=> '新的额度',
	'EDIT_ADD_AMOUNT'					=> '增加额度',
	'EDIT_SUB_AMOUNT'					=> '减去额度',
	'EDIT_USER_NOT_EXIST'				=> 'This user doesn\'t exist.',

	'INFO_GENERAL_INFORMATIONS'			=> '一般信息',
	'INFO_ATTACH'						=> '发新帖每个附件的积分',
	'INFO_ADD_ATTACH'					=> '每个附件的积分',
	'INFO_BONUS_CHANCE'					=> '积分奖励',
	'INFO_BONUS_CHANCE_EXPLAIN'			=> 'You currently have %1$s &#37; chance to get a bonus increment of %2$s to %3$s %4$s',
	'INFO_NO_COST'						=> '目前您不用为这个支付任何 %1$s',
	'INFO_NO_POINTS'					=> '目前您不会接收到关于这个的任何 %1$s',
	'INFO_POLL'							=> '新投票的积分',
	'INFO_POLL_OPTION'					=> '新投票每个选项的积分',
	'INFO_TOPIC_WORD'					=> '发帖每个词的积分',
	'INFO_TOPIC_CHARACTER'				=> '发帖每个字符的积分',
	'INFO_POST_WORD'					=> '回复每个词的积分',
	'INFO_POST_CHARACTER'				=> '回复每个字符的积分',
	'INFO_COST_DL_ATTACH'				=> '下载附件的花费',
	'INFO_COST_WARNING'					=> '警告的花费',
	'INFO_REG_BONUS'					=> '注册获得积分',

	'LOGS_COMMENT'						=> 'Comment',
	'LOGS_DATE'							=> '日期',
	'LOGS_DESCRIPTION'					=> '您将在这里查看您的日志.<br />您将看到所有您已经发送或接收的转让列表.<br />如果您在查找某条转让，使用排序选项.<br /><br />',
	'LOGS_REASON_NOLOGS'				=> '没有日志.',
	'LOGS_RECV'							=> 'Received',
	...
	'MAIN_LOTTERIES_NONE'				=> '目前还没有..',
	'MAIN_LOTTERY_TICKETS'				=> '您现在有 %1$s 票.',
	'MAIN_LOTTERIES_WON'				=> '赢得最大的彩票',
	'MAIN_MOST_DONATED'					=> '最大的捐款',
	'MAIN_MOST_DONATED_NONE'			=> '目前还没有捐款..',
	'MAIN_ON_HAND'						=> '您现在手头上有 %1$s %2$s.',
	'MAIN_RICH_BANK'					=> '首富',
	'MAIN_RICH_BANK_NONE'				=> '没有储户..',
	...
	'POINTS_INFO'						=> '信息',
	'POINTS_INFO_DESCRIPTION'			=> '您会在这里发现我们 %1$s 政策的附加信息.<br /><br />除这些值之外，在某些话题上您可能接收额外的 %1$s.<br /><br />请注意，坛主可以完全禁用论坛获取 %1$s!',
	...
	'TRANSFER_AMOUNT'					=> '转让额',
	'TRANSFER_COMMENT'					=> '评论',
	'TRANSFER_DESCRIPTION'				=> '您可以转让一些 %1$s. 添加接收者名字和您想赞助的积分并点击发送即可. 转让日志将记录在您的日志文件里.',
	'TRANSFER_FEE'						=> '转让费',
	'TRANSFER_FEE_EXPLAIN'				=> '转让费比率',
	...
	'TRANSFER_SET_USERNAME'				=> '<b>您想赞助的用户名:</b>',
	'TRANSFER_TITLE'					=> '%1$s 转让',
	'TRANSFER_TO_NAME'					=> '您想转让一些 <strong>%2$s</strong> 给 <strong>%1$s</strong>',
